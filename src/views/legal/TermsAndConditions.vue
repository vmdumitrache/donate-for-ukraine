<template>
  <v-container>
    <p class="text-caption">Last updated: March 08, 2022</p>
    <p>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Donate for Ukraine.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Donate for Ukraine, accessible from
          <a
            href="https://donateforukraine.org"
            rel="external nofollow noopener"
            target="_blank"
            >https://donateforukraine.org</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>
        ...
        <a
          href="https://donateforukraine.org/contact-us"
          rel="external nofollow noopener"
          target="_blank"
          >https://donateforukraine.org/contact-us</a
        >
      </li>
    </ul>
  </v-container>
